...
public class IcTest7490 
{
	public void result90()
	{
		...
		if(t.dec(fin1)==16&&t.dec(fin2)==12&&t.dec(fin3)==10)
		string+="\nMOD-5 COUNTER IS GOOD";
		else
		string+="\nMOD-5 COUNTER IS BAD"+" "+t.dec(fin1)+" "+t.dec(fin2)+" "+t.dec(fin3);
		...
		string+="\nMOD-2 COUNTER IS BAD"+t.dec(fin4);
			...
			JOptionPane.showMessageDialog(null,string,"Test Result of Ic7490",
