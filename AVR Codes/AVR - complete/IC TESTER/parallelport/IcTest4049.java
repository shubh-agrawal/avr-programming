...
public class IcTest4049 
{
	public void result4049()
	{
	 	out t=new out();
		...
		declaration.DDRB(0xa5);//setting upperside of or gate
		declaration.DDRD(0xab);//setting lowerside of or gate		
		//for all 1
		...
		if(t.dec(fin4)==2)
		string+="\nOUTPUT ON PIN 15IC IS GOOD";
		else
		string+="\nOUTPUT ON PIN 15 IC IS BAD";
		...
		JOptionPane.showMessageDialog(null,string,"Test Result of Ic4049",
